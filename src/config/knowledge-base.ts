...
export const KNOWLEDGE_BASE: KnowledgeTopic[] = [
  {
    ...
    keywords: [
      ...
      "graba de noche",
      "graban de noche",
      "como graban de noche",
      "cómo graban de noche",
      "como se ve de noche",
      "cómo se ve de noche",
      "como miran de noche",
      "cómo miran de noche",
  ...
  },
  {
    ...
    keywords: [
      ...
      "tell me about your package",
      "can you tell me about the package",
      "can you tell me about the package you offer",
    ...
    englishAnswer:
      "Yes. Our standard package starts with 4 cameras, installation, recorder, phone setup, and warranty included. We also have other options depending on the property and the quality level you want.",
    spanishAnswer:
      "Sí. Nuestro paquete estándar empieza con 4 cámaras, instalación, grabador, configuración en el celular y garantía incluidos. También tenemos otras opciones dependiendo de la propiedad y del nivel de calidad que busque.",
    shouldQualifyAfterAnswer: true,
    handoffRecommended: false,
  },
  {
    ...
    keywords: [
      ...
      "la aplicacion viene incluida",
      "la aplicación viene incluida",
      "ver desde el celular",
      "verlas en el celular",
      "ver en el telefono",
      "ver en el teléfono",
  ...
  },
  {
    ...
    keywords: [
      ...
      "extra every month",
      "monthly to see them on my phone",
      "pay monthly to see them on my phone",
      "mensualidad",
  ...
  },
  {
    ...
    keywords: [
      ...
      "do you charge extra for the app",
