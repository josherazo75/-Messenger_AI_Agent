...
export const KNOWLEDGE_BASE: KnowledgeTopic[] = [
  ...
  },
  {
    ...
    englishAnswer:
      "That depends a little on the job, but I can explain how it is normally handled. For a standard install, I can guide you based on the property and package first.",
    spanishAnswer:
      "Eso depende un poco del trabajo, pero sí le puedo explicar cómo se maneja normalmente. Para una instalación estándar, le puedo orientar primero según la propiedad y el paquete.",
    shouldQualifyAfterAnswer: true,
    handoffRecommended: false,
  },
  {
